...
@protocol JTTableViewControllerDelegate <NSObject>
...
@property (weak, nonatomic)  id<JTTableViewControllerDelegate> iDelegate;
@property (strong, nonatomic)  NSString *iLoadingCellXib;
@property (nonatomic)  BOOL isLoadingCellXib;
/*!
